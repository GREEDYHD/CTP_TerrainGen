...
ShaderTerrain::ShaderTerrain(const ShaderTerrain& other)
{
...
bool ShaderTerrain::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;

	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"Terrain.fx");
	if (!result)
	{
		return false;
	}
...
bool ShaderTerrain::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMFLOAT4X4 worldMatrix, XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor, XMFLOAT3 lightDirection, ID3D11ShaderResourceView* texture)
{
	bool result;
...
bool ShaderTerrain::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* _Filename)
{
	HRESULT result;
...
bool ShaderTerrain::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMFLOAT4X4 worldMatrix, XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor, XMFLOAT3 lightDirection, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
