...
bool Model::Initialize(ID3D11Device* device, ID3D11DeviceContext* context, WCHAR* textureFilename)
{
	bool result;
...
bool Model::LoadTexture(ID3D11Device* device, ID3D11DeviceContext* context, WCHAR* filename)
{
	bool result;
