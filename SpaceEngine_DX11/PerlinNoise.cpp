...
double PerlinNoise::CosInterpolate(float v1, float v2, float a)
{
	double angle = a * 3.141592653;
	double prc = (1.0f - cos(angle)) * 0.5f;
	return v1 * (1.0f - prc) + v2 * prc;
}

double PerlinNoise::PerlinNoise2D(int seed, float persistence, int octave, float x, float y)
{
