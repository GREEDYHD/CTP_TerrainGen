...
void QuadTree::Render(Frustum* frustum, ID3D11DeviceContext* deviceContext, ShaderTerrain* shader)
{
...
void QuadTree::RenderNode(NodeType* node, Frustum* frustum, ID3D11DeviceContext* deviceContext, ShaderTerrain* shader)
{
	bool result;
